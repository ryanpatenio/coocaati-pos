          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="<?php echo WEB_ROOT."admin/"; ?>"class="logo d-flex align-items-center w-auto">
                  <img src="../assets/img/logo2.jpg" alt="">
                  <span class="d-none d-lg-block">Jedidiah's Bakeshop</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3" method="POST" id="master_lg">

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Username</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="text" name="myemail" class="form-control" id="yourUsername" required>
